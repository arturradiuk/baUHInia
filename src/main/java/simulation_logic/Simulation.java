        ...
        for (int i = 0; i < 100; i++) {
            ...
            for (int j = 0; j < 100; j++) {
                if (mapService.getMap(map_uuid).get(i, j).getType().toString() == "None")
                    ...
                    heat_val.get(i).add(simulate("Road", mapService.getMap(map_uuid).get(i, j)));
                else if (mapService.getMap(map_uuid).get(i, j).getType().toString() == "Green")
                    heat_val.get(i).add(simulate("Green", mapService.getMap(map_uuid).get(i, j)));
                else if (mapService.getMap(map_uuid).get(i, j).getType().toString() == "Concrete")
                    heat_val.get(i).add(simulate("Building", mapService.getMap(map_uuid).get(i, j)));
                else if (mapService.getMap(map_uuid).get(i, j).getType().toString() == "Building")
                    heat_val.get(i).add(simulate("Building", mapService.getMap(map_uuid).get(i, j)));
