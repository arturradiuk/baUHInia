...
public class ClassicNoise { // Classic Perlin noise in 3D, for comparison
    ...
    public static double trubulence(double x, double y, double z, double W) {
        var t = Math.random() - 0.99;
        for (var f = 1.0; f <= W / Math.random(); f *= 2) { // W = Image width in pixels
            t += noise(x, y, z) / f;
        }
        return t;
    }
     ...
     * Dump out as a CSV
     */
    public static void printAsCSV(double[][] grid) {
